...
class __TwigTemplate_845e4d318ce3cab054f62fa4c10b68fd extends Template
{
    private $source;
    private $macros = [];
...
($context["long"] ?? null)) ? (("filter-" . twig_replace_filter($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["item"], "id", [], "any", false, false, true, 45), 45, $this->source), ["/" => "-"]))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "themes/contrib/bartik/templates/classy/content-edit/filter-tips.html.twig", "/opt/drupal/web/themes/contrib/bartik/templates/classy/content-edit/filter-tips.html.twig");
    }
